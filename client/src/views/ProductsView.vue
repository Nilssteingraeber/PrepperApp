...
<template>
  <div class="products-page" style="height: fit-content">
    <div class="header">
      <Header></Header>
    </div>
    <div class="d-flex flex-row align-self-stretch">
      <div class="col-2" id="sidebar">
        <div class="vstack gap-2 m-2">
          <a class="p-3 rounded" href="/profile" id="profile-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-house-fill"
              viewBox="0 0 16 16" style="margin-right: 2%">
              <path
                d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z" />
              <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293z" />
            </svg>Profile</a>
          <a class="p-3 rounded" href="/products" id="current-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#49416D" class="bi bi-cart-check-fill"
              viewBox="0 0 16 16" style="margin-right: 2%">
              <path
          ...
          <a class="p-3 rounded" href="/recipes" id="profile-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-collection-fill"
              viewBox="0 0 16 16" style="margin-right: 2%">
              <path
          ...
          <a class="p-3 rounded" href="/settings" id="profile-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-gear-fill"
              viewBox="0 0 16 16" style="margin-right: 2%">
              <path
      ...
      <div class="col-10 p-2 m-2">
        <div class="row">
          <div class="col-5 shadow p-3 m-3 bg-white rounded" style="text-align: center" id="calender-calories"
